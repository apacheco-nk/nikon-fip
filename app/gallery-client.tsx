          ...
          <article className="photo-card" key={photo.filename}>
            ...
            <div className="photo-meta">
              ...
              <button
                ...
                aria-label={'Descargar en alta fotografía ' + (index + 1)}
              >
                <Download size={16} /> En alta
              </button>
              <button
                onClick={() => download(photo, true)}
                aria-label={'Descargar original fotografía ' + (index + 1)}
              >
                Original
              </button>
            </div>
            ...
            <div className="viewer-controls">
              ...
              <div className="slide-downloads">
                ...
                <button
                  ...
                  onClick={() => download(photos[selected], true)}
                >
                  Descargar original
                </button>
              </div>
